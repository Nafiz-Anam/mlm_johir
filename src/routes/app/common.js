...
import authUnapprove from "../../middleware/app/authUnapproved";
const Common = require("../../controllers/app/commonController");
const router = Router();
const {
  validateVisitor,
  validate,
} = require("../../middleware/app/validateDemoVisitor");
