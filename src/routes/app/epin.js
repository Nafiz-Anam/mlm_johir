...
const epin = require('../../controllers/app/epinController')
import {validateEpinPurchase,validate,validateEpinRequest,validateEpinTransfer} from '../../middleware/app/validateEpin'
const router = Router()
