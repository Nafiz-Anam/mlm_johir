...
router.post("/payout_request", validatePayoutRequest(), validate, Payout.payoutRequest);
...
router.post("/check_ewallet_balance", validateEwalletBalance(), validate, payments.checkEwalletBalance);
router.post(
