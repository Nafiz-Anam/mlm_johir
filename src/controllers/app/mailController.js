...
const { errorMessage } = require("../../utils/app/response");
...
exports.sentMailList = async (req, res) => {
  try {
    ...
    const mail_list = await MailServices.getSentMessages(id, filters, prefix);
...
exports.getAdminMailList = async (req, res) => {
  try {
    ...
    const mail_list = await MailServices.getAdminMailList(id, filters, prefix);
