...
const { mailConfig, sendMail } = require("../../utils/app/nodeMailer");
const { decrypt } = require("../../middleware/app/encryption");
...
exports.forgetPassword = async (req, res) => {
  try {
    ...
    if (userId) {
      ...
      if (emailId.toLowerCase() != email.toLowerCase()) {
    ...
    if (result) {
      let response = await successMessage({
        message: "forgot password mail sended successfully",
      });
      return res.json(response);
    } else {
