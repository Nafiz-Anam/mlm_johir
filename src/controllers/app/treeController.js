...
const treeService = require("../../utils/app/treeService");
...
//tree
exports.goToTree = async (req, res) => {
  try {
    ...
    const url = await common.createTreeLink(id, username, title, prefix);
    if (!url) {
