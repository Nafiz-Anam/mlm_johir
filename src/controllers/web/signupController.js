...
exports.userRegister = async (req, res) => {
    ...
    try {
        ...
        regr["regFromTree"] = postArr.reg_from_tree
            ? postArr.reg_from_tree
            : false;
            ...
            if (moduleStatus.subscription_status) {
                ...
                regr["productValidity"] = new Date(
                    currentDate.setMonth(
                        currentDate.getMonth() + regr["productValidity"]
                    )
                );
            } else {
...
async function confirmRegister(
    ...
    try {
        ...
        if (regr["usernameType"] == "dynamic") {
            let dynamicUsername = await SignUpServices.getDynamicUsername(
                prefix
            );
        ...
        await SignUpServices.addBySpecificPlan(
            user_id,
            regr.sponsorId,
            t,
            prefix
