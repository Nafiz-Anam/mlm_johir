...
const uploadFile = require("../../middleware/web/bannerUpload");
        ...
        try {
            ...
            Object.entries(newsLatest).map(([key, value]) => {
                ...
                news_data[key] = {
                    ...
                    news_date: moment(value.date).format(
...
exports.leads = async (req, res) => {
    ...
    try {
        ...
        await leadsDetails.update(
            {
                lead_status:
                    status == "Rejected" ? 0 : status == "Accepted" ? 2 : 1,
            },
            {
                transaction: t,
            },
    ...
    if (documentData.length > 0) {
        for await (let [key, value] of Object.entries(documentData)) {
            ...
            if (
                ...
                newdata[key][
                    "doc_icone"
                ] = `${process.env.ADMIN_URL}assets/images/logos/jpg.jpg`;
            }
            if (
                ext == ".pdf" ||
                ext == ".xlsx" ||
                ...
                newdata[key][
                    "doc_icone"
                ] = `${process.env.ADMIN_URL}assets/images/logos/doc.jpg`;
            }
            if (
                ext == ".mp4" ||
                ext == ".avi" ||
                ...
                newdata[key][
                    "doc_icone"
                ] = `${process.env.ADMIN_URL}assets/images/logos/mp4.jpg`;
            }
        }
    }
    res.json({
